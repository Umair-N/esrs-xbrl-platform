  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 px-6 py-4 border-b border-border bg-background">
        <h1 className="text-2xl font-bold">Report Editor & Tagging</h1>
      </div>
      ...
      <div className="flex-1 min-h-0">
        {!report ? (
          ...
          <ResizablePanelGroup direction="horizontal" className="h-full border-2 border-primary/30">
              ...
              <ResizablePanelGroup direction="vertical" className="h-full">
                ...
                <ResizablePanel defaultSize={40} minSize={20}>
                  <div className="h-full p-3 border-r border-border">
                    <Card className="h-full border-2 border-primary/20">
                      <CardContent className="p-3 h-full flex flex-col">
                        <h2 className="text-lg font-semibold mb-2 flex-shrink-0">Tagged Facts</h2>
              ...
              <div className="h-full border-l border-border bg-muted/5 flex flex-col">
                <div className="p-3 flex-1 min-h-0">
                  <Tabs defaultValue="tagging" className="h-full flex flex-col">
                    ...
                    <TabsContent value="tagging" className="flex-1 min-h-0 mt-3">
                    ...
                    <TabsContent value="context" className="flex-1 min-h-0 mt-3">
