...
import { ArrowRight, FileText, Tag, Calendar, BookOpen, FileCode, Users, LogOut, Sparkles, Shield, Zap, Star, TrendingUp, Award, CheckCircle, Globe, Lock, Rocket, BarChart3 } from 'lucide-react'
...
export default function Home() {
  ...
  const features = [
    {
      ...
      content: "Advanced OCR and NLP technology automatically extracts and structures data from your financial reports, reducing manual work by 90%.",
      href: "/editor",
    ...
    },
    {
      ...
      content: "Our AI suggests optimal contexts based on your data patterns and regulatory requirements, ensuring compliance accuracy.",
      href: "/contexts",
    ...
    },
    {
      ...
      content: "Navigate complex ESRS taxonomy with our interactive visual interface. Find concepts instantly with semantic AI search.",
      href: "/taxonomy",
    ...
    },
    {
      ...
      content: "Machine learning algorithms automatically suggest and apply XBRL tags based on content analysis and historical patterns.",
      href: "/editor",
    ...
    },
    {
      ...
      content: "Real-time validation engine checks compliance as you work, with detailed error reporting and suggested fixes.",
      href: "/xbrl-preview",
    ...
    },
    {
      ...
      content: "Sophisticated role-based access control, audit trails, and collaborative workflows for enterprise teams.",
      href: "/users",
  ...
  const stats = [
    { label: "Reports Processed", value: "50K+", icon: FileText },
    { label: "Time Saved", value: "90%", icon: TrendingUp },
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Advanced AI-powered tools designed to simplify your ESRS reporting workflow
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center text-white max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                Join 500+ enterprises who've reduced XBRL preparation time by 90% while achieving 99.9% accuracy.
              </p>
