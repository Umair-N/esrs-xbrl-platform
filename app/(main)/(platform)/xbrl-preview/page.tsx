...
type ViewMode = 'upload' | 'document' | 'table' | 'validator';
...
const IXBRLViewer: React.FC = () => {
  ...
  const runValidation = async (content?: string): Promise<void> => {
    ...
    const contentToValidate = content || parsedData?.rawContent || '';
  ...
  const handleCopy = (): void => {
    const textToCopy = parsedData?.rawContent || '';
  ...
  const handleDownload = (): void => {
    const textToDownload = parsedData?.rawContent || '';
    const downloadFileName = file?.name || 'document.xbrl';
      ...
      <div className='container mx-auto px-2 py-4 max-w-full'>
        ...
        <div className='text-center mb-4'>
          <h1 className='text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-2'>
            iXBRL Document Viewer & Validator
          </h1>
          <p className='text-lg text-gray-600'>
            Interactive iXBRL file analyzer with tag highlighting, metadata
            extraction, and validation
          </p>
        </div>

        {/* Navigation - Added validator tab */}
        {parsedData && (
        ...
        {parsedData && viewMode === 'validator' && (
          <div className='space-y-6'>
            {/* Validation Controls */}
            <div className='flex items-center justify-between mb-6'>
              <h2 className='text-2xl font-bold'>XBRL Document Validator</h2>
                    ...
                    <div className='space-y-1'>
                      <div className='flex justify-between'>
                        ...
                        <span className='font-medium'>
                          {validationResults.stats.totalFacts}
                        </span>
                      </div>
                      <div className='flex justify-between'>
                        <span className='text-sm text-muted-foreground'>
                        ...
                        <span className='font-medium'>
                          {validationResults.stats.contexts}
                        </span>
                      </div>
                      <div className='flex justify-between'>
                        <span className='text-sm text-muted-foreground'>
                        ...
                        <span className='font-medium'>
                          {validationResults.stats.fileSize}
                        </span>
                      </div>
                    </div>
                  )}
            ...
            <Card className='mb-6'>
              ...
              <CardContent>
                <div className='relative'>
                  <pre className='p-4 rounded-md bg-muted overflow-auto max-h-[400px] text-sm font-mono text-wrap'>
                    <code>{parsedData.rawContent}</code>
                  </pre>
                </div>
              </CardContent>
                    ...
                    {validationResults.isValid && (
                      <div className='p-4 bg-green-50 border border-green-200 rounded-md'>
                        ...
                        <p className='mt-1 text-sm text-green-600'>
                          The XBRL document is valid and ready for submission.
                          All required elements are present and properly
                          formatted.
                        </p>
                      </div>
                    )}
